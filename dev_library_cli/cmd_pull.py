...
from dev_library_cli.prompts import password_input, select_one
from dev_library_cli.render import OutputMode, esc, output_json, spinner
...
def _rewrite_kiro_hooks(content: dict, agent_id: str | None = None) -> dict:
    ...
    dev_library_cli when installed in a project-local virtual environment.
    """
...
def _collect_install_options(
    ...
    *,
    ...
    from dev_library_cli.render import format_model as _format_model
    ...
    if has_model_selection(harness):
        ...
        if explicit:
            ...
            from dev_library_cli import model_catalog as _catalog
...
def register_pull(app: typer.Typer):
    ...
    def pull(
        ...
        from dev_library_cli.lockfile import local_registry_name
        ...
        if hooks_cfg and isinstance(hooks_cfg, dict) and "path" in hooks_cfg:
            ...
            if isinstance(content, str):
                ...
                raw = re.sub(
                    r"(?<!/)python3? -m dev_library_cli\.",
                    f"{sys.executable} -m dev_library_cli.",
                    raw,
                )
        ...
        from dev_library_cli.cmd_skill import _sanitize_name, install_skill_from_git, install_skill_registry_direct
        ...
        if not dry_run:
            ...
            from dev_library_cli.lockfile import upsert_agent
