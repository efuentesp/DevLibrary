...
def build_copilot_hooks(hooks_dir: str = ".github/hooks", bash_cmd: str | None = None) -> dict:
    ...
    if bash_cmd is None:
        bash_cmd = f'"{sys.executable}" -m dev_library_cli.hooks.session_push --harness copilot --json-response'
...
$python = "{python_path}"
$stdinData | & $python -m dev_library_cli.hooks.session_push --harness copilot --json-response 2>$null
"""
