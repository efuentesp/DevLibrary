...
from dev_library_cli import client, render
...
from dev_library_cli.support import CollectorResult
from dev_library_cli.support.manifest import BundleManifest, compute_file_entry
from dev_library_cli.support.redaction import RedactionStats, redact_value
...
def bundle(
    ...
    if include_system:
        try:
            from dev_library_cli.support.collectors import system_info as _system_info_fn
