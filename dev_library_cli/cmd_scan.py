...
from dev_library_cli.render import OutputMode, console, output_json, spinner
...
def register_scan(app: typer.Typer):
    ...
    def scan(
        ...
        try:
            from dev_library_cli import config as obs_config
            ...
            if cfg.get("access_token") and cfg.get("server_url"):
                ...
                if unregistered:
                    from dev_library_cli import client as obs_client
