...
from dev_library_cli.shared.utils import _OBSERVAL_HOOK_MARKERS
...
class CodexAdapter(BaseAdapter):
    ...
    def patch_hooks(self, dry_run: bool) -> bool:
        from dev_library_cli.cmd_doctor import _patch_codex

        return _patch_codex(dry_run)

    def cleanup_hooks(self, dry_run: bool) -> bool:
        from dev_library_cli.cmd_doctor import _cleanup_codex
