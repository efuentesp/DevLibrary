...
class KiroAdapter(BaseAdapter):
    ...
    def resolve_session_source(self, event: dict[str, Any], home: Path | None = None) -> SessionSource | None:
        from dev_library_cli.sessions.kiro import find_kiro_jsonl, read_kiro_session_cwd, resolve_session_id
    ...
    def discover_session_sources(
        ...
        from dev_library_cli.sessions.kiro import find_sessions_dir, read_kiro_session_cwd
    ...
    def session_extra_fields(
        ...
        from dev_library_cli.sessions.kiro import read_kiro_credits
    ...
    def rewrite_agent_profile(self, content: dict, agent_id: str) -> dict:
        from dev_library_cli.cmd_pull import _rewrite_kiro_hooks

        return _rewrite_kiro_hooks(content, agent_id=agent_id)

    def patch_hooks(self, dry_run: bool) -> bool:
        from dev_library_cli.cmd_doctor import _patch_kiro

        return _patch_kiro(dry_run)

    def cleanup_hooks(self, dry_run: bool) -> bool:
        from dev_library_cli.cmd_doctor import _cleanup_kiro
